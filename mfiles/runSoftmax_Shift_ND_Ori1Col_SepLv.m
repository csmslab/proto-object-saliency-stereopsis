function runSoftmax_Shift_ND_Ori1Col_SepLv(filename1,filename2,dPercent,LR,octave,aspect,shift)
...
[resMap]=Softmax_Shift_ND_Ori1_SepLv(EPyr1,OPyr1,EPyr2,OPyr2,params);
expMap=single(zeros(size(resMap)));
expMap=expMap+resMap;

pyr1 = makePyramidDisparity2(rg1,params);
pyr2 = makePyramidDisparity2(rg2,params);
EPyr1 = edgeEvenPyramidDisGabor(pyr1,params);
[OPyr1,~] = edgeOddPyramidDisGabor(pyr1,params);
EPyr2 = edgeEvenPyramidDisGabor(pyr2,params);
[OPyr2,~] = edgeOddPyramidDisGabor(pyr2,params);
...
pyr1 = makePyramidDisparity2(gr1,params);
pyr2 = makePyramidDisparity2(gr2,params);
EPyr1 = edgeEvenPyramidDisGabor(pyr1,params);
[OPyr1,~] = edgeOddPyramidDisGabor(pyr1,params);
EPyr2 = edgeEvenPyramidDisGabor(pyr2,params);
[OPyr2,~] = edgeOddPyramidDisGabor(pyr2,params);
...
pyr1 = makePyramidDisparity2(by1,params);
pyr2 = makePyramidDisparity2(by2,params);
EPyr1 = edgeEvenPyramidDisGabor(pyr1,params);
[OPyr1,~] = edgeOddPyramidDisGabor(pyr1,params);
EPyr2 = edgeEvenPyramidDisGabor(pyr2,params);
[OPyr2,~] = edgeOddPyramidDisGabor(pyr2,params);
...
pyr1 = makePyramidDisparity2(yb1,params);
pyr2 = makePyramidDisparity2(yb2,params);
EPyr1 = edgeEvenPyramidDisGabor(pyr1,params);
[OPyr1,~] = edgeOddPyramidDisGabor(pyr1,params);
EPyr2 = edgeEvenPyramidDisGabor(pyr2,params);
[OPyr2,~] = edgeOddPyramidDisGabor(pyr2,params);
